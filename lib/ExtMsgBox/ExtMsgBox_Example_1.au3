...
While 1
	...
	Switch GUIGetMsg()
		Case $GUI_EVENT_CLOSE, $hButton7
			...
			_ExtMsgBoxSet(1)
			$nTest = _ExtMsgBox(32, "Yes|~No", "Query", "Are you sure?", 0, $hTest_GUI, 0, False) ; Note default focus button character
		...
		Case $hButton1
			...
			$iRetValue = _ExtMsgBox(@AutoItExe, "1|2|3|#4", "Test 1", $sMsg, 0, $hTest_GUI) ; Note changed focus button character
